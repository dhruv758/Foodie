        ...
        <>
            ...
            <div className="max-w-3xl mx-auto p-6 mt-10">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-[#C61B3E]">
                        :knife_fork_plate: Poll Summary
                    </h1>
                    <Button
                        variant="secondary"
                        onClick={() => navigate(`/poll/${pollId}/users`)}
                        className="bg-[#1AC073] text-white px-6 py-2 rounded-full hover:bg-green-700 transition duration-300"
                    >
                        User Info
                    </Button>
                </div>
                    ...
                    {summary.options.map((opt, i) => (
                        ...
                        >
                            <div>
                                ...
                                <p className="text-lg font-bold text-green-600">:ballot_box_with_ballot: {opt.vote_count} votes</p>
                            </div>
                            <a
